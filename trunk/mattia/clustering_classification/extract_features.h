...
public:
    ...
    ExtractFeatures (PointCloudPtr, std::vector<pcl::IndicesPtr>);
...
ExtractFeatures<PointT>::ExtractFeatures(PointCloudPtr cloud, std::vector<pcl::IndicesPtr> clusters) {
    cloud_=cloud;
    clusters_ = clusters;
...
template <class PointT>
void ExtractFeatures<PointT>::save()
{
